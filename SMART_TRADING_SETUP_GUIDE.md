...
The default App ID is `119552`. If you want to use your own:
...
1. **Market Analyzer**: `wss://ws.derivws.com/websockets/v3?app_id=119552`
   - Purpose: Real-time tick data
   - No authentication required
   - Subscribes to tick history

2. **Trading Executor**: `wss://ws.binaryws.com/websockets/v3?app_id=119552`
